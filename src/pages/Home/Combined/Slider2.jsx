     ...
     return (
          <>
               <div className=' max-w-[1000px] mx-auto  '>
                    ...
                    <div >
                         <div>
                              ...
                              >
                                   ...
                                   <SwiperSlide>
                                        <div className='shawobox p-2  rounded-xl overflow-hidden cursor-pointer  w-full  md:max-h-[600px]'>
                                             <img className=' w-full h-full rounded-xl' src={image2} alt="" />
                                        </div>
                                   </SwiperSlide>
                                   <SwiperSlide>
                                        <div className='shawobox p-2  rounded-xl overflow-hidden cursor-pointer  w-full  md:max-h-[600px]'>
                                             <img className=' w-full h-full rounded-xl' src={image1} alt="" />
                                        </div>
                                   </SwiperSlide>
                                   <SwiperSlide>
                                        <div className='shawobox p-2  rounded-xl overflow-hidden cursor-pointer  w-full  md:max-h-[600px]'>
                    ...
                    <h1 className=' mt-3 text-center text-base sm:text-lg md:text-xl xl:text-2xl 2xl:text-3xl font-semibold my-1'> Custodial </h1>
