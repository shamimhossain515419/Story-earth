...
const SecurityServices = () => {
     return (
          <div className=" max-w-[1600px] mx-auto md:py-20 bg-[#FFFFFF]">

               <Container>
                    <div>
                         <h1 className=" text-center tracking-[3px] whitespace-pre-line   font-normal  md:font-bold text-base sm:text-lg md:text-xl lg:text-3xl 2xl:text-4xl my-3"> Crypto Wallet Security  Like Never <br /> Before</h1>
                    ...
                    <div>
                         ...
                         <div style={{ backgroundImage: "url('../../../../public/easyAccessBG.a98e7c76.svg')" }} className=' p-3 py-10  bg-no-repeat object-contain  mx-auto   w-[100%] my-10 md:h-[80vh]'>
                              ...
                              <div className=' '>
                                   <h1 className=" text-center tracking-[1px]   mt-20 font-normal  md:font-bold text-base sm:text-lg md:text-xl lg:text-3xl 2xl:text-4xl my-3"> Easy Access To Crypto</h1>
                              ...
                              <div className=' relative  md:flex  w-full    justify-between  gap-10'>
                                   <div className=' w-full'>
                                        <div className=' h-[120px]  my-4 flex gap-3 border border-[#000] p-2 md:p-4 rounded-2xl '>
                                             ...
                                             <p className=' text-base sm:text-lg my md:text-xl  font-medium '> Built-In Cross Chain Aggregated <br /> Exchange</p>
                                        </div>
                                        <div className='my-4 h-[120px]  w-full  flex gap-3 border border-[#000] p-2 md:p-4 rounded-2xl '>
                                             <AiFillCheckCircle size={24}></AiFillCheckCircle>
                                             <p className=' text-base sm:text-lg my md:text-xl  font-medium '>
                                   ...
                                   <div className=' w-full'>
                                        ...
                                        <div className='my-4 h-[120px]  w-full  md:flex-row-reverse flex gap-3 border border-[#000] p-2 md:p-4 rounded-2xl '>
                                             <AiFillCheckCircle size={24}></AiFillCheckCircle>
                                             <p className=' text-base sm:text-lg my md:text-xl  font-medium '>Fast And Secure Transactions</p>
                                        </div>
                                        <div className='my-4 h-[120px]  w-full  md:flex-row-reverse  flex gap-3 border border-[#000] p-2 md:p-4 rounded-2xl '>
                                             <AiFillCheckCircle size={24}></AiFillCheckCircle>
                                             <p className=' text-base sm:text-lg my md:text-xl  font-medium '> 24x7 Live Support</p>
                                        </div>
                                   </div>
